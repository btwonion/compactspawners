...
fun generateGeneralCategory(): ConfigCategory = ConfigCategory.createBuilder().name(Component.translatable("menu.compactspawners.general.name"))
    .option(
    ...
    .option(
        Option.createBuilder<Boolean>().name(Component.translatable("menu.compactspawners.general.silkspawnerbreak"))
